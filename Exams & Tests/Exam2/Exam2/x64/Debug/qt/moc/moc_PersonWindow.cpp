...
Q_CONSTINIT static const qt_meta_stringdata_CLASSPersonWindowENDCLASS_t qt_meta_stringdata_CLASSPersonWindowENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(13, 17),  // "onCheckboxChanged"
        QT_MOC_LITERAL(31, 0),  // ""
        QT_MOC_LITERAL(32, 17)   // "onAddEventClicked"
    },
    "PersonWindow",
    "onCheckboxChanged",
    "",
...
void PersonWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onCheckboxChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
