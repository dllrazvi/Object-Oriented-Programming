...
public:
    ...
    void setupUi(QMainWindow *ExamClass)
    {
        ...
        eventsWidget->setGeometry(QRect(10, 0, 311, 361));
        latitudeWidget = new QListWidget(centralWidget);
        latitudeWidget->setObjectName("latitudeWidget");
        latitudeWidget->setGeometry(QRect(420, 0, 171, 21));
        longitudeWidget = new QListWidget(centralWidget);
        longitudeWidget->setObjectName("longitudeWidget");
        longitudeWidget->setGeometry(QRect(420, 30, 171, 21));
        label = new QLabel(centralWidget);
        label->setObjectName("label");
        label->setGeometry(QRect(340, 0, 81, 21));
        label_2 = new QLabel(centralWidget);
        label_2->setObjectName("label_2");
        label_2->setGeometry(QRect(340, 30, 81, 21));
        checkBox = new QCheckBox(centralWidget);
        checkBox->setObjectName("checkBox");
        checkBox->setGeometry(QRect(410, 60, 161, 91));
    ...
    void retranslateUi(QMainWindow *ExamClass)
    {
        ...
        label->setText(QCoreApplication::translate("ExamClass", "Latitude", nullptr));
        label_2->setText(QCoreApplication::translate("ExamClass", "Longitude", nullptr));
        checkBox->setText(QCoreApplication::translate("ExamClass", "NewEvents", nullptr));
    } // retranslateUi
